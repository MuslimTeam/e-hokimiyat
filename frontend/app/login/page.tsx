...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-blue-50 to-emerald-50 flex items-center justify-center p-4">
      {/* Background decoration */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-linear-to-br from-blue-400/20 to-emerald-400/20 rounded-full blur-3xl" />
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-linear-to-br from-emerald-400/20 to-purple-400/20 rounded-full blur-3xl" />
      </div>

      <div className="relative w-full max-w-md">
        {/* Main Card */}
        <Card className="bg-card/95 backdrop-blur-xl border border-border/50 shadow-2xl rounded-3xl overflow-hidden">
          <CardHeader className="text-center space-y-6 p-8 bg-linear-to-br from-primary/5 via-primary/10 to-primary/5">
            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-3xl bg-linear-to-br from-primary to-primary/80 shadow-lg">
          ...
          {step === "initial" && (
            <div>
              ...
              <Button
                className="w-full h-12 text-base font-semibold bg-linear-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                size="lg"
          ...
          {step === "checking" && (
            <div className="flex flex-col items-center justify-center py-12 space-y-6">
              <div className="relative">
                ...
                <div className="absolute -inset-2 bg-linear-to-br from-primary/20 to-primary/10 rounded-3xl animate-pulse" />
              </div>
            ...
            <div className="space-y-6">
              <div className="flex flex-col items-center text-center py-6">
                <div className="relative mb-6">
                  ...
                  <div className="absolute -inset-2 bg-linear-to-br from-green-500/20 to-emerald-600/20 rounded-3xl animate-pulse" />
                </div>
              ...
              <Button
                className="w-full h-12 text-base font-semibold bg-linear-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 gap-2"
                size="lg"
          ...
          {step === "not_found" && (
            <div className="space-y-6">
              <div className="flex flex-col items-center text-center py-6">
                <div className="relative mb-6">
                  <div className="w-16 h-16 bg-linear-to-br from-red-500 to-red-600 rounded-2xl flex items-center justify-center shadow-lg">
                    <XCircle className="h-8 w-8 text-white" />
                  </div>
                  <div className="absolute -inset-2 bg-linear-to-br from-red-500/20 to-red-600/20 rounded-3xl animate-pulse" />
                </div>
          ...
          {step === "success" && (
            <div className="flex flex-col items-center justify-center py-12 space-y-6">
              <div className="relative">
                <div className="w-20 h-20 bg-linear-to-br from-green-500 to-emerald-600 rounded-3xl flex items-center justify-center shadow-xl">
                  <CheckCircle2 className="h-10 w-10 text-white" />
                </div>
                <div className="absolute -inset-3 bg-linear-to-br from-green-500/30 to-emerald-600/30 rounded-4xl animate-pulse" />
              </div>
              <div className="text-center space-y-2">
