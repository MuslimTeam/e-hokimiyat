...
import { usePerformanceMonitor } from "@/hooks/use-performance-new"

export default function DashboardPage() {
  const performance = usePerformanceMonitor('Dashboard')
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="space-y-8 py-8">
            ...
            <OptimizedSection delay={200}>
              <div className="grid gap-8 lg:grid-cols-3 animate-slide-up" style={{ animationDelay: "200ms" }}>
