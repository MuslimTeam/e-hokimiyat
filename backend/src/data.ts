...
export enum AppealCategory {
  IS_BILAN_TA_MINLASH = 'IS_BILAN_TA_MINLASH',
  TA_LIM = 'TA_LIM',
  INFRASTRUKTURA = 'INFRASTRUKTURA',
  SOG_LIQNI_SAQLASH = 'SOG_LIQNI_SAQLASH',
  IJTIMOIY = 'IJTIMOIY',
  KOMMUNAL_XIZMATLAR = 'KOMMUNAL_XIZMATLAR',
  BOSHQA = 'BOSHQA'
}
...
export const appeals: Appeal[] = [
  {
    ...
    phone: "+998901234567",
    status: AppealStatus.KUTILMOQDA,
    priority: AppealPriority.ORTA,
    category: AppealCategory.IS_BILAN_TA_MINLASH,
  ...
  },
  {
    ...
    phone: "+998902345678",
    status: AppealStatus.JARAYONDA,
    priority: AppealPriority.YUQORI,
    category: AppealCategory.TA_LIM,
  ...
  },
  {
    ...
    email: "bekzod.rahimov@ehokimiyat.uz",
    phone: "+998903456789",
    status: AppealStatus.HAL_ETILGAN,
    priority: AppealPriority.PAST,
    category: AppealCategory.INFRASTRUKTURA,
  ...
  },
  {
    ...
    status: AppealStatus.KUTILMOQDA,
    priority: AppealPriority.YUQORI,
    category: AppealCategory.SOG_LIQNI_SAQLASH,
  ...
  {
    id: "5",
    title: "Ижтимоий ёрдам",
    content: "Оила ёқитганларга ижтимоий ёрдам кўрсатиш керак. Мухтож оилалар бор.",
    applicant: "Сардор Алиев",
    email: "sardor.aliev@ehokimiyat.uz",
    phone: "+998905678901",
    status: AppealStatus.JARAYONDA,
    priority: AppealPriority.ORTA,
    category: AppealCategory.IJTIMOIY,
    createdAt: "2026-01-11T11:30:00Z",
    department: "Ижтимоий муҳофаза бўлими",
    district: "2"
  },
  {
    id: "6",
    title: "Сув таъминоти",
    content: "Маҳалламизда сув муаммолари бор, кунларга сув келмаяпти.",
    applicant: "Гулчехра Рахимова",
    email: "gulchehra.rahimova@ehokimiyat.uz",
    phone: "+998906789012",
    status: AppealStatus.HAL_ETILGAN,
    priority: AppealPriority.YUQORI,
    category: AppealCategory.KOMMUNAL_XIZMATLAR,
    createdAt: "2026-01-10T08:00:00Z",
    response: "Сув таъминоти тизими таъмирланди. Ҳозирда муаммо йўқ.",
    department: "Сув хўжалиги бўлими",
    district: "3"
  }
]
